...
We can't actually query OpenAI / Perplexity / Gemini cheaply, so we use Claude
Sonnet 4.6 to simulate each assistant's likely behavior given the prompt. This is
