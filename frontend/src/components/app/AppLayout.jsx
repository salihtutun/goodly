...
import { LayoutDashboard, FolderKanban, Gauge, Sparkles, LogOut, User, CreditCard, ClipboardList, Share2, Bot } from "lucide-react";
...
const navItems = [
  ...
  { to: "/app/social", label: "Social Reach", icon: Share2, testId: "nav-social" },
